...
const Subaccount = () => {
  const { traccarUser, flespiToken } = useAppContext();
  ...
  useEffect(() => {
    if (traccarUser?.superAdmin === true) {
      setItem({
        ...item,
            ...
            <AccordionDetails className={classes.details}>
              ...
              {!openIdForced && (
                <>
                  <Typography
                    variant="caption"
                    sx={{ color: "red", fontWeight: "bold", mb: -1, mt: -1 }}
                  >
                    *Password must be 17 characters long.
                  </Typography>
                  <TextField
                    type="password"
                    onChange={(e) =>
            ...
            <AccordionDetails className={classes.details}>
              ...
              <FormGroup>
                <FormControlLabel
                  ...
                  disabled={!traccarUser.superAdmin}
                />
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={item.administrator === true ? true : false}
                      onChange={(e) =>
