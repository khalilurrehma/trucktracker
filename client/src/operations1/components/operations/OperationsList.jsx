...
import { Search, Pencil, Bookmark, Map, Trash2, Plus, ChevronLeft, ChevronRight, BarChart3, Loader2, Copy } from "lucide-react";
import { Button } from "../ui/button";
import { Input } from "../ui/input";
import { cn } from "../../lib/utils";
const OperationsList = ({ operations, onEdit, onDelete, onView, onCreate, onDuplicate, className, deletingId, duplicatingId, }) => {
