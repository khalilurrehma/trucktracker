...
const META_FIELDS = {
  ...
  LOAD_PAD: [{ key: "load_pad_max_duration_min", label: "Vehicle maximun time inside LOAD_PAD / to activate an alert" }],
  DUMP_AREA: [{ key: "dump_area_max_duration_min", label: "Vehicle maximun time inside DUMP_AREA / to activate an alert" }],
  ZONE_AREA: [
